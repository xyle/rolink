...
hello;
    ...
    private function parseWidgetsBlock(string &$content): void
    {
        ...
        if ($result) {
            ...
            $designingTheme = cookie('rolink_design_theme');
            ...
            foreach ($matches as $match) {
                ...
                if ($designingTheme) {
                    if (!isset($array['class'])) {
                        $attrs[] = 'class="__rolink_widgets_block"';
                    }
                    $attrs[] = 'data-rolink_widgets_block_name="' . $name . '"';
                    $attrs[] = 'data-rolink_theme_file_id="' . $widgetsBlocks[$name]['_file_id'] . '"';
                }
                ...
                foreach ($array as $attrName => $attrValue) {
                    ...
                    if ($attrName == 'class' && $designingTheme) {
                        $attrValue = '__rolink_widgets_block ' . $attrValue;
                    }
