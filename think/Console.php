...
use rolink\console\command\Clear;
...
use rolink\console\command\VendorPublish;
use rolink\console\command\Version;
...
//        'route:list'       => RouteList::class,
    ...
    {
        if ($this->app->version()) {
            return sprintf('<comment>%s</comment>', 'ThinkPHP v' . $this->app->version() . ' & Rolink v' . rolink_version());
        }
